 ...
 * @author bahlef
 */
public final class JsoupHtmlFormatterWrapper {
	/** Default system line separator. */
	private static final String DEFAULT_LINE_SEPARATOR = "\n";

	/**
	 * Package private Constructor for creating a new instance of {@link JsoupHtmlFormatterWrapper}.
	 */
	JsoupHtmlFormatterWrapper() {
	}
	...
	public String format(String code, String lineFeed, Document.OutputSettings options) {
		...
		options.syntax(Document.OutputSettings.Syntax.html);
	...
	private String format(Document.OutputSettings options, @NonNull String code, String lineFeed) {
		Document document = Jsoup.parse(code, "", Parser.htmlParser());
