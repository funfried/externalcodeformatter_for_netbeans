        ...
        for (Breakpoint breakpoint : breakpoints) {
            ...
            if (breakpoint instanceof LineBreakpoint) {
                ...
                try {
                    ...
                    LOG.log(Level.WARNING, "{0} cannot be converted to URI/File: {1}. Please report to https://github.com/funfried/eclipsecodeformatter_for_netbeans/issues/55", new Object[]{url, ex.getMessage()});
                    continue;
                }
