...
public class EclipseFormatterPanel extends javax.swing.JPanel implements VerifiableConfigPanel {
	...
	public EclipseFormatterPanel(Preferences preferences, boolean showsProjectSettings) {
		...
		this.cbEnableSaveActionModifiedLinesOnly.setVisible(FEATURE_FORMAT_CHANGED_LINES_ONLY);
		this.cbEnableSaveActionModifiedLinesOnly.setEnabled(FEATURE_FORMAT_CHANGED_LINES_ONLY);
	}
	...
	public void store() {
		...
		if (FEATURE_FORMAT_CHANGED_LINES_ONLY) {
