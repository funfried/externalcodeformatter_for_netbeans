...
public class EclipseFormatterPanel extends javax.swing.JPanel implements VerifiableConfigPanel {
	...
	private void initComponents() {
		...
		org.openide.awt.Mnemonics.setLocalizedText(lblLinefeed, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel.class, "EclipseFormatterPanel.lblLinefeed.text")); // NOI18N
		lblLinefeed.setToolTipText(org.openide.util.NbBundle.getMessage(EclipseFormatterPanel.class, "EclipseFormatterPanel.lblLinefeed.toolTipText")); // NOI18N

		cbLinefeed.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "System", "\\n", "\\r\\n", "\\r" }));

		lblSourceLevel.setLabelFor(cbSourceLevel);
		org.openide.awt.Mnemonics.setLocalizedText(lblSourceLevel, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel.class, "EclipseFormatterPanel.lblSourceLevel.text")); // NOI18N
		...
		org.openide.awt.Mnemonics.setLocalizedText(cbEnableSaveActionModifiedLinesOnly,
				org.openide.util.NbBundle.getMessage(EclipseFormatterPanel.class, "EclipseFormatterPanel.cbEnableSaveActionModifiedLinesOnly.text")); // NOI18N
	...
	private void btnVisitHomePageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVisitHomePageMouseClicked
		try {
			HtmlBrowser.URLDisplayer.getDefault().showURLExternal(new URL("https://github.com/funfried/eclipsecodeformatter_for_netbeans/"));
		} catch (MalformedURLException ex) {
			Exceptions.printStackTrace(ex);
		}
	...
	public void load() {
		...
		loadOptionsWindowUI(isEclipseFormatterEnabled, eclipseFormatterLocation, eclipseFormatterProfile, showNotifications, enableSaveAction, preserveBreakpoints, useProjectPrefs,
				enableSaveActionModifiedLines, lineFeed, sourceLevel);
		fireChangedListener();
	}

	private void loadOptionsWindowUI(boolean isEclipseFormatterEnabled, String formatterFile, String profile, boolean showNotifications, boolean enableSaveAction, boolean preserveBreakpoints,
			boolean useProjectPrefs, boolean enableSaveActionModifiedLines, String lineFeed, String sourceLevel) {
