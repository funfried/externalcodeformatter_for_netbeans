...
public class Utils {
	@StaticResource
	public static final String EXTERNAL_FORMATTER_ICON_PATH = "de/funfried/netbeans/plugins/eclipse/formatter/external.gif";

	@StaticResource
	public static final String ECLIPSE_ICON_PATH = "de/funfried/netbeans/plugins/eclipse/formatter/eclipse.gif";

	@StaticResource
	public static final String GOOGLE_ICON_PATH = "de/funfried/netbeans/plugins/eclipse/formatter/google.gif";

	@StaticResource
	public static final String NETBEANS_ICON_PATH = "de/funfried/netbeans/plugins/eclipse/formatter/netbeans.gif";
