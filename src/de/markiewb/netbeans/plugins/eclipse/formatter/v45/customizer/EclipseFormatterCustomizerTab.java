 ...
 */
package de.markiewb.netbeans.plugins.eclipse.formatter.v45.customizer;
...
import de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.EclipseFormatterPanel45;
...
public class EclipseFormatterCustomizerTab implements ProjectCustomizer.CompositeCategoryProvider {
    ...
    @StaticResource
    private static final String ICON = "de/markiewb/netbeans/plugins/eclipse/formatter/v45/eclipse.gif";
    ...
    public JComponent createComponent(final Category category, final Lookup lkp) {
        Preferences projectPreferences = ProjectUtils.getPreferences(lkp.lookup(Project.class), EclipseFormatterPanel45.class, true);
        final EclipseFormatterPanel45 configPanel = new EclipseFormatterPanel45(projectPreferences, true);
