 ...
 */
package de.markiewb.netbeans.plugins.eclipse.formatter.v45.options;

import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.ECLIPSE_FORMATTER_ACTIVE_PROFILE;
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.ECLIPSE_FORMATTER_ENABLED;
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.ECLIPSE_FORMATTER_LOCATION;
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.ENABLE_SAVEACTION;
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.PRESERVE_BREAKPOINTS;
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.PROJECT_PREF_FILE;
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.SHOW_NOTIFICATIONS;
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.USE_PROJECT_PREFS;
import de.markiewb.netbeans.plugins.eclipse.formatter.v45.customizer.VerifiableConfigPanel;
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.ENABLE_SAVEACTION_MODIFIEDLINESONLY;
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.FEATURE_formatChangedLinesOnly;
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.LINEFEED;
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.SOURCELEVEL;
import de.markiewb.netbeans.plugins.eclipse.formatter.v45.xml.ConfigReadException;
import de.markiewb.netbeans.plugins.eclipse.formatter.v45.xml.ConfigReader;
import de.markiewb.netbeans.plugins.eclipse.formatter.v45.xml.Profile;
...
@Keywords(location = "Java", tabTitle = "Eclipse Formatter 4.5", keywords = {"eclipse", "format", "eclipse formatter"})
public class EclipseFormatterPanel45 extends javax.swing.JPanel implements VerifiableConfigPanel {
    ...
    public EclipseFormatterPanel45(Preferences preferences, boolean showsProjectSettings) {
        initComponents();
        enableUI();
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(browseButton, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.browseButton.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.jLabel1.text")); // NOI18N

        formatterLocField.setText(org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.formatterLocField.text")); // NOI18N

        errorLabel.setForeground(new java.awt.Color(255, 51, 51));
        org.openide.awt.Mnemonics.setLocalizedText(errorLabel, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.errorLabel.text")); // NOI18N
        errorLabel.setToolTipText(org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.errorLabel.toolTipText")); // NOI18N

        lblProfile.setLabelFor(cbProfile);
        org.openide.awt.Mnemonics.setLocalizedText(lblProfile, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.lblProfile.text")); // NOI18N

        cbPreserveBreakpoints.setSelected(true);
        org.openide.awt.Mnemonics.setLocalizedText(cbPreserveBreakpoints, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.cbPreserveBreakpoints.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel4, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.jLabel4.text")); // NOI18N
        jLabel4.setEnabled(false);

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.jLabel2.text")); // NOI18N
        jLabel2.setEnabled(false);

        org.openide.awt.Mnemonics.setLocalizedText(cbUseProjectPref, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.cbUseProjectPref.text")); // NOI18N

        lblLinefeed.setLabelFor(cbLinefeed);
        org.openide.awt.Mnemonics.setLocalizedText(lblLinefeed, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.lblLinefeed.text")); // NOI18N
        lblLinefeed.setToolTipText(org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.lblLinefeed.toolTipText")); // NOI18N

        cbLinefeed.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "System", "\\n", "\\r\\n", "\\r" }));

        lblSourceLevel.setLabelFor(cbSourceLevel);
        org.openide.awt.Mnemonics.setLocalizedText(lblSourceLevel, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.lblSourceLevel.text")); // NOI18N
        ...
        jLabel2.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.jLabel2.AccessibleContext.accessibleName")); // NOI18N

        buttonGroup1.add(rbUseNetBeans);
        org.openide.awt.Mnemonics.setLocalizedText(rbUseNetBeans, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.rbUseNetBeans.text")); // NOI18N

        buttonGroup1.add(rbUseEclipse);
        org.openide.awt.Mnemonics.setLocalizedText(rbUseEclipse, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.rbUseEclipse.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(txtProjectSpecificHint, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.txtProjectSpecificHint.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(cbShowNotifications, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.cbShowNotifications.text")); // NOI18N
        cbShowNotifications.setToolTipText(org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.cbShowNotifications.toolTipText")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(cbEnableSaveAction, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.cbEnableSaveAction.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(btnDonate, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.btnDonate.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(btnVisitHomePage, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.btnVisitHomePage.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(cbEnableSaveActionModifiedLinesOnly, org.openide.util.NbBundle.getMessage(EclipseFormatterPanel45.class, "EclipseFormatterPanel45.cbEnableSaveActionModifiedLinesOnly.text")); // NOI18N
    ...
    private void loadEclipseFormatterFileForPreview(String formatterFile, String activeProfile) {
        ...
        if (file.exists()) {
            try {
                ...
                if (de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.isXMLConfigurationFile(fo.getNameExt())) {
    ...
    boolean valid() {
        ...
        if (rbUseEclipse.isSelected()) {
            ...
            final boolean isXML = de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.isXMLConfigurationFile(file.getName());
            final boolean isEPF = de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.isWorkspaceMechanicFile(file.getName());
            final boolean isProjectSetting = de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.isProjectSetting(file.getName());
