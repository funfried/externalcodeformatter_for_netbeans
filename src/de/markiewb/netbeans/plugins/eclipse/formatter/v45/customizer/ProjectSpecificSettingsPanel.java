...
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.USE_PROJECT_SETTINGS;
...
public class ProjectSpecificSettingsPanel extends javax.swing.JPanel implements VerifiableConfigPanel {
    ...
    private final EclipseFormatterPanel45 innerComponent;

    ProjectSpecificSettingsPanel(EclipseFormatterPanel45 innerComponent, Preferences projectPreferences) {
        initComponents();
    ...
    private void lblJumpToGlobalOptionsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblJumpToGlobalOptionsMouseClicked
         OptionsDisplayer.getDefault().open("Java"+ "/de.markiewb.netbeans.plugins.eclipse.formatter.v45.options");
