 ...
 */
package de.markiewb.netbeans.plugins.eclipse.formatter.v45.strategies;

import de.markiewb.netbeans.plugins.eclipse.formatter.v45.Utilities;
import de.markiewb.netbeans.plugins.eclipse.formatter.v45.strategies.eclipse.EclipseFormatter;
import de.markiewb.netbeans.plugins.eclipse.formatter.v45.strategies.eclipse.EclipseFormatter.CannotLoadConfigurationException;
import de.markiewb.netbeans.plugins.eclipse.formatter.v45.strategies.eclipse.EclipseFormatter.ProfileNotFoundException;
...
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.getActivePreferences;
import static de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.getLineFeed;
import de.markiewb.netbeans.plugins.eclipse.formatter.v45.strategies.eclipse.EclipseFormatterStrategy;
import de.markiewb.netbeans.plugins.eclipse.formatter.v45.strategies.netbeans.NetBeansFormatterStrategy;
import java.io.File;
...
public class FormatterStrategyDispatcher {
    ...
    public String getNotificationMessageForEclipseFormatterConfigurationFileType(String formatterFile, String formatterProfile) {
        String msg = "";
        if (de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.isWorkspaceMechanicFile(formatterFile)) {
            //Workspace mechanic file
            msg = String.format("Using %s", formatterFile);
        } else if (de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.isXMLConfigurationFile(formatterFile)) {
            //XML file
            msg = String.format("Using profile '%s' from %s", formatterProfile, formatterFile);
        } else if (de.markiewb.netbeans.plugins.eclipse.formatter.v45.options.Preferences.isProjectSetting(formatterFile)) {
