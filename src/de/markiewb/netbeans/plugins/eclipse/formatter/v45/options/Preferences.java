...
public class Preferences {
    ...
    public static java.util.prefs.Preferences getActivePreferences(final StyledDocument styledDoc) {
        java.util.prefs.Preferences globalPreferences = NbPreferences.forModule(EclipseFormatterPanel45.class);
...
//            NotificationDisplayer.getDefault().notify("Project", null, "" + project, null);
            java.util.prefs.Preferences projectPreferences = ProjectUtils.getPreferences(project, EclipseFormatterPanel45.class, true);
