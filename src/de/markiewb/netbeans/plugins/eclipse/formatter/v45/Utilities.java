...
public class Utilities {
    ...
    @StaticResource
    private static final String ECLIPSE = "de/markiewb/netbeans/plugins/eclipse/formatter/v45/eclipse.gif";
    @StaticResource
    private static final String NETBEANS = "de/markiewb/netbeans/plugins/eclipse/formatter/v45/netbeans.gif";
