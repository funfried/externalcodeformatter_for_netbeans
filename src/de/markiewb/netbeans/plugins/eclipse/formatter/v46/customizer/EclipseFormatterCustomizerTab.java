 ...
 */
package de.markiewb.netbeans.plugins.eclipse.formatter.v46.customizer;
...
import de.markiewb.netbeans.plugins.eclipse.formatter.v46.options.EclipseFormatterPanel46;
...
public class EclipseFormatterCustomizerTab implements ProjectCustomizer.CompositeCategoryProvider {
    ...
    @StaticResource
    private static final String ICON = "de/markiewb/netbeans/plugins/eclipse/formatter/v46/eclipse.gif";
    ...
    @NbBundle.Messages({"LBL_Config=Eclipse Formatting 4.6"})
    @Registrations({
