...
public class FormatTest {
	...
	public void testFormatUsingXML() {
		EclipseFormatter formatter = new EclipseFormatter("src/test/resources/formattersampleeclipse.xml", "eclipse-demo", null, null);
	...
	public void testFormatUsingEPF() {
		EclipseFormatter formatter = new EclipseFormatter("src/test/resources/mechanic-formatter.epf", null, null, null);
		final String text = "package foo;public enum NewEmptyJUnitTest { A, B, C}";
		final String expected = "package foo;\n"
				+ "\n"
				+ "public enum NewEmptyJUnitTest {\n"
	...
	public void testFormatUsingProjectSettings() {
		EclipseFormatter formatter = new EclipseFormatter("src/test/resources/org.eclipse.jdt.core.prefs", null, null, null);
		final String text = "package foo;public enum NewEmptyJUnitTest { A, B, C}";
		final String expected = "package foo;\n"
				+ "\n"
				+ "public enum NewEmptyJUnitTest {\n"
	...
	public void testFormatUsingProjectSettings_ExplicitDefaultFormatter() {
		EclipseFormatter formatter = new EclipseFormatter("src/test/resources/defaultformatter_org.eclipse.jdt.core.prefs", null, null, null);
		final String text = "package foo;public enum NewEmptyJUnitTest { A, B, C}";
		final String expected = "package foo;\n"
				+ "\n"
				+ "public enum NewEmptyJUnitTest {\n"
	...
	public void testFormatUsingProjectSettings_Explicit3rdPartyFormatter_Failure() {
		EclipseFormatter formatter = new EclipseFormatter("src/test/resources/3rdPartyFormatter_org.eclipse.jdt.core.prefs", null, null, null);
		final String text = "package foo;public enum NewEmptyJUnitTest { A, B, C}";
		try {
	...
	public void testFormatUsingLinefeed_CR() {
		EclipseFormatter formatter = new EclipseFormatter("src/test/resources/org.eclipse.jdt.core.prefs", null, "\\r", null);
		final String text = "package foo;public enum NewEmptyJUnitTest { A, B, C}";
	...
	public void testFormatUsingLinefeed_LF() {
		EclipseFormatter formatter = new EclipseFormatter("src/test/resources/org.eclipse.jdt.core.prefs", null, "\\n", null);
		final String text = "package foo;public enum NewEmptyJUnitTest { A, B, C}";
		final String expected = "package foo;\n"
				+ "\n"
				+ "public enum NewEmptyJUnitTest {\n"
